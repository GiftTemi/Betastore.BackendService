...
{
    public class GetAllCustomers : IRequest<Result>
    {
    ...
    public class GetAllCustomersHandler : IRequestHandler<GetAllCustomers, Result>
    {
        ...
        public GetAllCustomersHandler(IApplicationDbContext context, ILogger<GetAllCustomersHandler> logger, IIdentityService identityService, IMapper mapper)
        {
            _context = context;
            _logger = logger;
            _mapper = mapper;
        ...
        public async Task<Result> Handle(GetAllCustomers request, CancellationToken cancellationToken)
        {
            try
            {
